$(document).ready(function() {
	...
	var vis = d3.select("#cpu-call-tree").append("svg:svg")
	...
	function update(source) {
	    ...
	    nodeEnter.append("svg:text")
	        ...
	        .text(function(d) { return method_regex.exec(d.methodName)[0]; })
